...
lazy_static! {
    ...
    pub static ref ROOMLIST_HTML: String = {
        let mut file = File::open("static/room_list.html").unwrap();
        let mut contents = String::new();
        file.read_to_string(&mut contents).unwrap();
        contents
    };
    pub static ref PLAYING_0_HTML: String = {
        let mut file = File::open("static/playing_0.html").unwrap();
        let mut contents = String::new();
        file.read_to_string(&mut contents).unwrap();
        contents
    };
    pub static ref PLAYING_1_HTML: String = {
        let mut file = File::open("static/playing_1.html").unwrap();
        let mut contents = String::new();
        file.read_to_string(&mut contents).unwrap();
        contents
    };
